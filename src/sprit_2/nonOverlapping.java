...
public class nonOverlapping extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableOfNonOverlap = new javax.swing.JTable();
        ...
        jPanel1.setBackground(new java.awt.Color(204, 156, 227));

        tableOfNonOverlap.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tableOfNonOverlap.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        tableOfNonOverlap.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableOfNonOverlapMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tableOfNonOverlap);
        ...
        jLabel1.setText("Non-Overlap Sessions");
    ...
    private void tableOfNonOverlapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableOfNonOverlapMouseClicked

    }//GEN-LAST:event_tableOfNonOverlapMouseClicked

    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        try {
             conn = cObj.getConnection(); //---get connection---
                DefaultTableModel table = (DefaultTableModel) tableOfNonOverlap.getModel();
                int [] Index = tableOfNonOverlap.getSelectedRows();
                Object [] column = new Object[8];
                
                if(tableOfNonOverlap.getRowCount() == 0)//---If Table is empty---
                {
                    JOptionPane.showMessageDialog(this, "Now, Table is Empty.");
                }
                else if(tableOfNonOverlap.getSelectedRowCount() > 0)
                {
                    int response = JOptionPane.showConfirmDialog(null, "Are you sure to delete?", "Delete", JOptionPane.YES_NO_OPTION);
                        if(response == JOptionPane.YES_OPTION)
                        {
                            ...
                            {//---start for loop---
                                ...
                                String deleteQuery = "delete from  non_overlap where ID="+ deletedId +" ";
    ...
    private void txtSerachKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSerachKeyReleased
       DefaultTableModel table = (DefaultTableModel) tableOfNonOverlap.getModel();
        ...
        tableOfNonOverlap.setRowSorter(sort);
    ...
    {
        try{
                String sql = "select * From non_overlap";
    ...
    private javax.swing.JTable tableOfNonOverlap;
